  ...
  return (
    <footer className="mx-auto mt-10 w-[min(1120px,calc(100%_-_48px))] border-t border-[var(--border)] pb-8 pt-10 max-[700px]:w-[calc(100%_-_32px)]">
      <div className="grid grid-cols-[minmax(230px,1.4fr)_repeat(3,minmax(100px,auto))] gap-12 max-[800px]:grid-cols-2 max-[700px]:gap-x-8 max-[700px]:gap-y-9">
        <div className="max-w-[290px] max-[800px]:col-span-2"><button className="cursor-pointer border-0 bg-transparent p-0" type="button" onClick={onHome} aria-label="LoveMyDocument home"><BrandLogo /></button><p className="mb-0 mt-3 text-xs leading-5 text-[var(--muted)]">Fast, private file tools for everyday document work.</p></div>
